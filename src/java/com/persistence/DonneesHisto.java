...
public class DonneesHisto {
     ...
     * @param con
     * @param  id
     * @return DonneesHisto trouvé par id
     * @throws java.lang.Exception
     */
    public static DonneesHisto getByID(Connection con, int id) throws Exception {
    ...
    public static DonneesHisto getLastByImmatriculation(Connection con,
     ...
     /**
     * Indique le nb de donneesHisto dans la base de données
     * @param con
     * @return le nombre de vehicules
     * @throws java.lang.Exception
     */
    public static int size(Connection con) throws Exception {
        String queryString = "select count(*) as count from donneesHisto";
        Statement lStat = con.createStatement(
                                            ResultSet.TYPE_SCROLL_INSENSITIVE, 
                                            ResultSet.CONCUR_READ_ONLY);
        ResultSet lResult = lStat.executeQuery(queryString);
